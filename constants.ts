export const COMPANY_INFO = {
  ...
  hours: {
    ...
    other: "Cualquier otro horario, atendemos previa cita"
  },
  social: {
    facebook: "https://www.facebook.com/pinkavenuemexico",
    instagram: "@pinkavenuetiariasyjoyería"
  }
};

export const CATEGORIES = ['Todas', 'Bodas', 'XV Años', 'Gala', 'Casual'];