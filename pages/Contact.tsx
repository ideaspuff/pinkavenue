...
const Contact: React.FC = () => {
  return (
    <div className="pt-24 min-h-screen bg-white">
      {/* Header Image */}
      <div className="w-full h-[80vh] overflow-hidden relative mb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="lg:col-span-5 fade-in">
            <div className="mb-12">
              ...
              <p className="text-gray-500 font-light text-lg leading-relaxed text-justify">
              ...
              <p className="text-gray-500 font-light text-lg leading-relaxed mt-4 italic">
            ...
            <div className="space-y-10">
              ...
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">concierge@pinkavenue.com.mx</p>
                </div>
              </div>
          ...
          {/* Map / Visual Side */}
          <div className="lg:col-span-7 relative h-[650px] bg-stone-100 slide-up overflow-hidden group">
            <iframe
