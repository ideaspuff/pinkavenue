    ...
    return (
        <div className="pt-24 pb-0 bg-white">
            ...
            <section className="py-24 px-6 max-w-5xl mx-auto text-center slide-up">
                ...
                <div className="prose prose-lg mx-auto text-gray-600 font-light leading-loose text-justify md:text-center">
                    <p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="relative h-[600px] group overflow-hidden shadow-2xl">
                            ...
                            <div className="absolute bottom-8 left-8 bg-white/90 backdrop-blur-md p-6 max-w-xs border-l-4 border-brand-main">
                                ...
                                <p className="text-xs text-gray-600 uppercase tracking-widest">Claridad VVS • 56 Facetas</p>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-12">
                                <Link to="/catalogo" className="font-sans inline-flex items-center gap-3 bg-gray-900 text-white px-8 py-4 uppercase tracking-[0.2em] text-xs font-bold hover:bg-brand-main transition-colors">
            ...
            <section className="py-24 px-6 max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
                    ...
                    <div className="bg-white p-6 text-center relative group">
                        ...
                        <h3 className="font-bold uppercase tracking-widest text-sm mb-4">La Inspiración</h3>
                    ...
                    <div className="bg-white p-6 text-center relative group">
                        ...
                        <h3 className="font-bold uppercase tracking-widest text-sm mb-4">La Cita Privada</h3>
                        <p className="text-gray-500 font-light text-sm leading-relaxed">
                    ...
                    <div className="bg-white p-6 text-center relative group">
                        ...
                        <h3 className="font-bold uppercase tracking-widest text-sm mb-4">La Prueba de Luz</h3>
                        <p className="text-gray-500 font-light text-sm leading-relaxed">
                    ...
                    <div className="bg-white p-6 text-center relative group">
                        ...
                        <h3 className="font-bold uppercase tracking-widest text-sm mb-4">El Legado</h3>
                        <p className="text-gray-500 font-light text-sm leading-relaxed">
            ...
            <section className="py-24 bg-white text-center">
                <div className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="flex justify-center gap-6">
                        <Link to="/catalogo" className="font-sans px-8 py-3 border border-gray-200 uppercase tracking-widest text-xs font-bold hover:border-brand-main hover:text-brand-main transition-colors">
                            Ver Galería
                        </Link>
                        <Link to="/contacto" className="font-sans px-8 py-3 bg-brand-main text-white border border-brand-main uppercase tracking-widest text-xs font-bold hover:bg-brand-dark transition-colors">
                            Visitar Showroom
                        </Link>
                    </div>
