    ...
    <div className="bg-white min-h-screen pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16 fade-in pt-10">
          <span className="text-brand-main text-xs font-bold uppercase tracking-[0.3em] block mb-3">Archivo de Diseño 2024</span>
        ...
        <div className="flex flex-wrap justify-center gap-8 md:gap-12 mb-20 border-t border-b border-gray-100 py-6">
          {CATEGORIES.map((category) => (
            <button
              ...
              className={`text-xs uppercase tracking-[0.2em] transition-all duration-500 ${
