...
const Home: React.FC = () => {
  ...
  return (
    <div className="w-full bg-white pt-24">
      ...
      {/* 3. STATEMENT SECTION (Fix: Removed floating margins, added padding for cohesion) */}
      <Reveal>
        <div className="relative h-[80vh] w-full bg-gray-900 overflow-hidden flex items-center justify-center py-24">
          {/* Parallax Background */}
          <div
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
            ...
            <div className="mt-12">
              <Link to="/nosotros" className="inline-block border border-white/30 px-10 py-4 text-xs font-sans font-bold uppercase tracking-[0.2em] hover:bg-white hover:text-gray-900 transition-all duration-300 backdrop-blur-sm">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-16">
            {featuredProducts.map((product, index) => (
              ...
              </Reveal> // Wrapped individual items for staggered feel, but minimal delay to avoid slowness
            ))}
          </div>
          ...
          <Reveal>
            <div className="mt-24 text-center border-t border-gray-100 pt-16">
              ...
              >
                <span className="font-sans bg-gray-900 text-white px-12 py-4 text-xs uppercase tracking-[0.2em] font-bold group-hover:bg-brand-main transition-all duration-300 shadow-lg">
        ...
        <section className="relative py-24 bg-brand-dark overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
            ...
            <button
              ...
              className="font-sans bg-white text-brand-dark px-10 py-5 uppercase tracking-[0.2em] text-xs font-bold hover:bg-brand-gold hover:text-white transition-all duration-300 shadow-2xl"
            >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 bg-stone-100">
          ...
          <div className="order-1 lg:order-2 flex items-center justify-center p-12 lg:p-24 bg-white">
            <div className="max-w-md">
              ...
              <Link to="/contacto" className="font-sans inline-block bg-gray-900 text-white px-8 py-3 text-xs uppercase tracking-widest font-bold hover:bg-brand-main transition-colors">
                Reservar Showroom
              </Link>
            </div>
          </div>
